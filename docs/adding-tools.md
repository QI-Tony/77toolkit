...
2. Add a renderer to `apps/browser-tools/shared/app.js`.
3. Register the renderer by slug at the bottom of that file.
4. Run `npm run build`; the root build creates its page, canonical URL,
